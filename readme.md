...
- P2 - Trimming: [Fastp](https://github.com/OpenGene/fastp) is used to trim low qaulity reads. This step also includes QC filtering.\
 ...
 - P7 - Integrate genomic with epidemiological and public health data to drive outbreak surveilance using surveillance tools such as [Nextstrain](https://nextstrain.org/), [Microreact](https://docs.microreact.org/)
